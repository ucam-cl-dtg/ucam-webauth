...
public class WebauthRequest implements Serializable { 
    ...
    { "ver", "url", "desc", "aauth", "iact", "msg", 
      "params", "date", "fail" };

    private HashMap data = new HashMap();

    /**
     * Default constructor. "ver" defaults to 1, "date" to the
    ...
    /**
     * Returns an iterator of all the field names that this request
     * currently contains.
     *
     ...
     *
     * @param field the name of the to set
    ...
    /**
     * Sets a field in this request to a long value expressing a
     * date. The date is represented as the number of milliseconds
    ...
    /**
     * Sets a field in this request to the values from a
    ...
    public void set(String field, Collection value) {

	StringBuffer buff = new StringBuffer();

	for (Iterator it = value.iterator(); it.hasNext(); ) {
	    buff.append(((String)it.next()).trim());
	    if (it.hasNext())
		buff.append(",");
	}
     ...
     * field from this request.
     *
     * @param the field to return
     *
     * @return an integer expressing the value of the request field
     * or -1 if the request doesn't have a field of this name or it
     * was empty
     *
     * @throws NumberFormatException if the field can't be converted
     * into an int
     *
     */
    ...
    /**
     * Returns the value of the specified request field as a long
     * value that represents a date. The date is returned as the
     * number of milliseconds since January 1, 1970 GMT.
     *
     * @param the name of the field to return
     *
     * @return an integer expressing the value of the specified
     * request field as a long value that represents a date
     *
     * @throws ParseException if the field can't be converted
     * into an date
     *
     */
     ...
     * strings from the specified field from this request
     *
     * @param the name of the field to return
     *
     * @return a java.utils.Collection containing the comma-seperated
     * strings from the specified request field. Returns an empty
     * collection if the request doesn't have a field of this name or
     * it was empty
     */
	...
	for (int i=0; i<FIELD_NAME.length; ++i) {
	    ...
	    str.append(FIELD_NAME[i] + 
		       "=" + 
		       URLEncoder.encode(get(FIELD_NAME[i])));
	}
