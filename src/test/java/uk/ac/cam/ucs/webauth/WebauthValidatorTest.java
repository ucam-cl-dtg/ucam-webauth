...
public class WebauthValidatorTest extends TestCase {
	...
	private static final String RESPONSE_V2_FIRSTHAND = "2!200!!20050317T151310Z!1111072390-26663-9!http://raven.cam.ac.uk/d"
	...
	private static final String RESPONSE_V2_SSO = "2!200!!20050317T151424Z!1111072462-26473-5!http://raven.cam.ac.uk/d"
	...
	private static final String RESPONSE_V1 = "1!200!!20050317T151538Z!1111072536-26473-6!http://raven.cam.ac.uk/d"
	...
	private static final String RESPONSE_ERROR = "1!530!Missing required parameter 'ver'!20050317T151628Z!1111072588-"
	...
	private static final String RESPONSE_SUMMER = "2!200!!20050331T145628Z!1112280988-1756-8!http://raven.cam.ac.uk/de"
	...
	private static final String RESPONSE_FORGED = "2!200!!20050314T140111Z!1110808871-12726-166!http://raven.cam.ac.u"
	...
	private static final String MISS_VER = "!200!!20050314T140111Z!1110808871-12726-166!http://raven.cam.ac.u"
			+ "k/debug.html!jw35!pwd!!36000!Foo babies!2!VB4vcoeQSln6SKJGT7RauhLna"
			+ "aVmNBtWZ8Ra5tzYv0-0GRNHBxrZxQK9SNwg0lw3eV6SPyWbDJwjSlgNAh9FvOVzxjOx"
			+ "C30SgS8802dPjqnratjAKDqZBfBv004pslSdWsoE-CiHfAXAMUDzE9I.TH-RCKkqtMq"
			+ "XwoRn4f.lXtU_";

	private static final String BAD_VER = "A!200!!20050314T140111Z!1110808871-12726-166!http://raven.cam.ac.u"
			+ "k/debug.html!jw35!pwd!!36000!Foo babies!2!VB4vcoeQSln6SKJGT7RauhLna"
			+ "aVmNBtWZ8Ra5tzYv0-0GRNHBxrZxQK9SNwg0lw3eV6SPyWbDJwjSlgNAh9FvOVzxjOx"
			+ "C30SgS8802dPjqnratjAKDqZBfBv004pslSdWsoE-CiHfAXAMUDzE9I.TH-RCKkqtMq"
			+ "XwoRn4f.lXtU_";

	private static final String MISS_STATUS = "2!!!20050314T140111Z!1110808871-12726-166!http://raven.cam.ac.u"
			+ "k/debug.html!jw35!pwd!!36000!Foo babies!2!VB4vcoeQSln6SKJGT7RauhLna"
			+ "aVmNBtWZ8Ra5tzYv0-0GRNHBxrZxQK9SNwg0lw3eV6SPyWbDJwjSlgNAh9FvOVzxjOx"
			+ "C30SgS8802dPjqnratjAKDqZBfBv004pslSdWsoE-CiHfAXAMUDzE9I.TH-RCKkqtMq"
			+ "XwoRn4f.lXtU_";

	private static final String SMALL_STATUS = "2!1!!20050314T140111Z!1110808871-12726-166!http://raven.cam.ac.u"
			+ "k/debug.html!jw35!pwd!!36000!Foo babies!2!VB4vcoeQSln6SKJGT7RauhLna"
			+ "aVmNBtWZ8Ra5tzYv0-0GRNHBxrZxQK9SNwg0lw3eV6SPyWbDJwjSlgNAh9FvOVzxjOx"
			+ "C30SgS8802dPjqnratjAKDqZBfBv004pslSdWsoE-CiHfAXAMUDzE9I.TH-RCKkqtMq"
			+ "XwoRn4f.lXtU_";

	private static final String MISS_ID = "2!200!!20050314T140111Z!!http://raven.cam.ac.u"
			+ "k/debug.html!jw35!pwd!!36000!Foo babies!2!VB4vcoeQSln6SKJGT7RauhLna"
			+ "aVmNBtWZ8Ra5tzYv0-0GRNHBxrZxQK9SNwg0lw3eV6SPyWbDJwjSlgNAh9FvOVzxjOx"
			+ "C30SgS8802dPjqnratjAKDqZBfBv004pslSdWsoE-CiHfAXAMUDzE9I.TH-RCKkqtMq"
			+ "XwoRn4f.lXtU_";

	private static final String MISS_URL = "2!200!!20050314T140111Z!1110808871-12726-166!"
			+ "!jw35!pwd!!36000!Foo babies!2!VB4vcoeQSln6SKJGT7RauhLna"
			+ "aVmNBtWZ8Ra5tzYv0-0GRNHBxrZxQK9SNwg0lw3eV6SPyWbDJwjSlgNAh9FvOVzxjOx"
			+ "C30SgS8802dPjqnratjAKDqZBfBv004pslSdWsoE-CiHfAXAMUDzE9I.TH-RCKkqtMq"
			+ "XwoRn4f.lXtU_";

	private static final String MISS_PRINCIPAL = "2!200!!20050314T140111Z!1110808871-12726-166!http://raven.cam.ac.u"
			+ "k/debug.html!!pwd!!36000!Foo babies!2!VB4vcoeQSln6SKJGT7RauhLna"
			+ "aVmNBtWZ8Ra5tzYv0-0GRNHBxrZxQK9SNwg0lw3eV6SPyWbDJwjSlgNAh9FvOVzxjOx"
			+ "C30SgS8802dPjqnratjAKDqZBfBv004pslSdWsoE-CiHfAXAMUDzE9I.TH-RCKkqtMq"
			+ "XwoRn4f.lXtU_";

	private static final String NO_AUTH_SSO = "2!200!!20050314T140111Z!1110808871-12726-166!http://raven.cam.ac.u"
			+ "k/debug.html!jw35!!!36000!Foo babies!2!VB4vcoeQSln6SKJGT7RauhLna"
			+ "aVmNBtWZ8Ra5tzYv0-0GRNHBxrZxQK9SNwg0lw3eV6SPyWbDJwjSlgNAh9FvOVzxjOx"
			+ "C30SgS8802dPjqnratjAKDqZBfBv004pslSdWsoE-CiHfAXAMUDzE9I.TH-RCKkqtMq"
			+ "XwoRn4f.lXtU_";

	private static final String BAD_AUTH_SSO = "2!200!!20050314T140111Z!1110808871-12726-166!http://raven.cam.ac.u"
			+ "k/debug.html!jw35!pw!pw!36000!Foo babies!2!VB4vcoeQSln6SKJGT7RauhLna"
			+ "aVmNBtWZ8Ra5tzYv0-0GRNHBxrZxQK9SNwg0lw3eV6SPyWbDJwjSlgNAh9FvOVzxjOx"
			+ "C30SgS8802dPjqnratjAKDqZBfBv004pslSdWsoE-CiHfAXAMUDzE9I.TH-RCKkqtMq"
			+ "XwoRn4f.lXtU_";

	private static final String MISS_KID = "2!200!!20050314T140111Z!1110808871-12726-166!http://raven.cam.ac.u"
			+ "k/debug.html!jw35!pwd!!36000!Foo babies!!VB4vcoeQSln6SKJGT7RauhLna"
			+ "aVmNBtWZ8Ra5tzYv0-0GRNHBxrZxQK9SNwg0lw3eV6SPyWbDJwjSlgNAh9FvOVzxjOx"
			+ "C30SgS8802dPjqnratjAKDqZBfBv004pslSdWsoE-CiHfAXAMUDzE9I.TH-RCKkqtMq"
			+ "XwoRn4f.lXtU_";

	private static final String BAD_KID = "2!200!!20050314T140111Z!1110808871-12726-166!http://raven.cam.ac.u"
			+ "k/debug.html!jw35!pwd!!36000!Foo babies!3!VB4vcoeQSln6SKJGT7RauhLna"
			+ "aVmNBtWZ8Ra5tzYv0-0GRNHBxrZxQK9SNwg0lw3eV6SPyWbDJwjSlgNAh9FvOVzxjOx"
			+ "C30SgS8802dPjqnratjAKDqZBfBv004pslSdWsoE-CiHfAXAMUDzE9I.TH-RCKkqtMq"
			+ "XwoRn4f.lXtU_";

	private static final String MISS_SIG = "2!200!!20050314T140111Z!1110808871-12726-166!http://raven.cam.ac.u"
