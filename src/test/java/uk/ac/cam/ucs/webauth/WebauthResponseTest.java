...
public class WebauthResponseTest extends TestCase {
	...
	"1!200!A Message %21%21 %25%25!20050303T151131Z!1109862691-30323-5!h" +
    ...
    private static final String OTHER_RESPONSE = 
	"1!200!A Message %21%21 %25%25!20050303T151131Z!1109862691-30323-5!h" +
	...
	"1!410!!20050303T151131Z!1109862691-30323-5!http://raven.cam.ac.uk/" +
	"debug.html!!!!!!!";

    private static final String SHORT_RESPONSE = 
	"1!200!A Message %21%21 %25%25!20050303T151131Z!1109862691-30323-5!h" +
        "ttp://raven.cam.ac.uk/debug.html!jw99!pwd!foo,bar!36000!for babies" +
        "!2";
	...
	"A!!!20050303T151131Z!!http://a.b/c/!!!!!!!";

    private static final String HIGH_VER = 
	"99!!!20050303T151131Z!!http://a.b/c/!!!!!!!";

    private static final String BAD_STATUS = 
	"!A!!20050303T151131Z!!http://a.b/c/!!!!!!!";

    private static final String BAD_ISSUE = 
	"!!!TODAY!!http://a.b/c/!!!!!!!";
    
    private static final String BAD_LIFE = 
	"!!!20050303T151131Z!!http://a.b/c/!!!!A!!!";

    private static final String SUMMER_RESPONSE = 
	"1!200!A Message %21%21 %25%25!20050603T151131Z!1109862691-30323-5!h" +
        "ttp://raven.cam.ac.uk/debug.html!jw35!pwd!foo,bar!36000!for babies" +
        "!2!B1PKo8dhTP6eJKCo52xm5IMvzIJI6EaH90u.irWKrnYluaQRePHi6jQOXRBfJ2sG" +
        "9GxBh821.q-KdFMVYicjbWBkWO-xJ1VpJBPiPCVtX1KKG4nSYPfcQEmz5SQDGg9OTES" +
	"SprdK7wz0H-aGviMsNPU30UlCQh1hdrzmpThwoek_";
	...
	assertEquals
	    ("1!200!A Message %21%21 %25%25!20050303T151131Z!1109862691-303" +
	     ...
	     "0!for babies",
	     ok_response.getRawData());
	assertEquals
	    ("1!410!!20050303T151131Z!1109862691-30323-5!http://raven.cam." +
	     "ac.uk/debug.html!!!!!",
	     cancel_response.getRawData());
        assertEquals
	    ("!!!!!!!!!!",
	     null_response.getRawData());
    }
